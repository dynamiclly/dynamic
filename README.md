...
- `Command + N, Control + Enter` 生成代码
- `Control + O` 覆盖方法（重写父类方法）
- `Control + I` 实现方法（实现接口中的方法）
- `Command + Option + T` 包围代码（使用if..else, try..catch, for, synchronized等包围选中代码）
- `Command + /` 注释/取消注释与行注释
...
- `Command + Shift + ] / Command + Shift + [`  左右切换打开的编辑tab页
- `F12` 返回到前一个工具窗口
- `Esc` 从工具窗口进入代码文件窗口
...
- `Command + Option + ] / Command + Option + [` 移动光标到当前所在代码的花括号开始/结束位置
